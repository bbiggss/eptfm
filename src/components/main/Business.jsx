    ...
    <BusinessBox id="business">
      <div id="container">
        ...
        <div id="contentsWrap">
          <ul>
            <BusinessItems
              img={`${process.env.PUBLIC_URL}/assets/images/bussiness_img1.png`}
              hoverImg={`${process.env.PUBLIC_URL}/assets/images/bussiness_img1_over.png`}
              text={'VR/AR'}
              hoverText={
            ...
            />
            <BusinessItems
              img={`${process.env.PUBLIC_URL}/assets/images/bussiness_img2.png`}
              hoverImg={`${process.env.PUBLIC_URL}/assets/images/bussiness_img2_over.png`}
              text={'e-Learning'}
              hoverText={
            ...
            />
            <BusinessItems
              img={`${process.env.PUBLIC_URL}/assets/images/bussiness_img3.png`}
              hoverImg={`${process.env.PUBLIC_URL}/assets/images/bussiness_img3_over.png`}
              text={'R&D'}
              hoverText={
