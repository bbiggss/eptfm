    ...
    <StyledMainPortfolio id="portfolio">
      ...
      <div className="marginWrapper">
        <div id="portfolioTexts">
          <p id="portfolioTitle" className="slideUp" ref={(el) => (refs.current[0] = { ref: el })}>
            PORTFOLIO
          </p>
          <p id="portfolioText1" className="slideUp" ref={(el) => (refs.current[1] = { ref: el })}>
            미래의 학습을 <span>설계하다</span>
          </p>

          <div id="portfolioText2" className="slideUp" ref={(el) => (refs.current[2] = { ref: el })}>
        ...
        <ButtonWrapper>
          <PfFieldButton ref={(el) => (refs.current[3] = { ref: el })} title={'VR/AR'} link={'portfolio/VrAr'} />
          <PfFieldButton ref={(el) => (refs.current[4] = { ref: el })} title={'e-Learning'} link={'portfolio/e-Learning'} />
          <PfFieldButton ref={(el) => (refs.current[5] = { ref: el })} title={'R&D'} link={'portfolio/R&D'} />
        </ButtonWrapper>
      </div>
    </StyledMainPortfolio>
  );
