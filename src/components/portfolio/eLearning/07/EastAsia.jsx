  ...
  return (
    <StyledEastAsia>
      ...
      <div className="fullScreen maxWidth1260Wrapper">
        <WidthOneContent>
          <Img src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/07_EastAsia/group1/1.png`} />
          <CustomText
        ...
        <WidthOneContent>
          <Img src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/07_EastAsia/group1/2.png`} />
          <CustomText
            className="customText"
            text={
              isMobile
        ...
        <WidthOneContent>
          <Img src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/07_EastAsia/group1/3.png`} />
          <CustomText
            className="customText"
            text={
              isMobile
        ...
        <WidthOneContent $last>
          <Img src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/07_EastAsia/group1/4.png`} />
          <CustomText
            text={
              isMobile
