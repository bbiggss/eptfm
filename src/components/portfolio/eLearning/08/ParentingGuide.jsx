  ...
  return (
    <StyledParentingGuide>
      ...
      <div className="fullScreen heroArea">
        <PortfolioTitle className="centeredContentWithMarginBottom" organization={'아동권리보장원'} title={'위탁모를 위한 양육 길잡이'} />

        <img src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/08_ParentingGuide/hero.png`} alt="" />
      </div>
      ...
      <div className="fullScreen relative">
        ...
        <div className="centerAlignment">
          ...
          <PortfolioIntroduction
            title={'위탁모와 입양 부모를 위한 실질적이고 따뜻한 양육 가이드,\n아이와 함께하는 새로운 여정의 길잡이'}
            description={
      ...
      <ImageTextBlock>
        ...
        />
        <TextCenter text={'학습자는 입양 및 위탁 보호의 개념과 절차,\n그리고 그들이 아동에게 미치는 영향에 대해 학습할 수 있어요.'} />
      </ImageTextBlock>
      <ImageTextBlock>
        <Img
          $whiteImgBackgroundBorder
      ...
      <ImageTextBlock>
        ...
        />
        <TextCenter text={'아이들의 발달 단계에 맞는 양육 방법과 건강 관리, 교육 및 생활 습관 \n지도에 대한 구체적인 조언을 확인해볼 수 있어요.'} />
      </ImageTextBlock>
      <ImageTextBlock style={{ marginBottom: '200px' }}>
        ...
        />
        <TextCenter text={'위탁모와 입양 가정의 특별한 여정,\n그들의 역할이 얼마나 중요한지 그들이 마주하게 되는 도전과 보람을 이해해볼까요?'} />
      </ImageTextBlock>

      <div className="centerAlignment">
        <Img style={{}} src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/08_ParentingGuide/group2/2.png`} />
      </div>
    </StyledParentingGuide>
  );
};
