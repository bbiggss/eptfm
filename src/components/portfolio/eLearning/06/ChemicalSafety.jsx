...
const ChemicalSafety = () => {
  ...
  return (
    <StyledChemicalSafety>
      ...
      <div className="fullScreen maxWidth1260Wrapper">
        <WidthOneContent $first>
          <Img src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/06_ChemicalSafety/group1/1.png`} />
          <CustomText
            text={
              isMobile
        ...
        <WidthOneContent>
          <Img $whiteImgBackgroundBorder src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/06_ChemicalSafety/group1/2.png`} />
          <CustomText
            text={
              isMobile
        ...
        <WidthOneContent>
          <Img $whiteImgBackgroundBorder src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/06_ChemicalSafety/group1/3.png`} />
          <CustomText
            text={
              isMobile
                ? '학습 내용은 다양한 형태로 구성되어\n 학습자의 지루함을 줄여줘요.\n텍스트 설명 외에도 사진, 애니메이션, 인터랙티브\n 시뮬레이션 등을 포함하여 학습자가\n 몰입할 수 있는 환경을 제공해요.'
                : isTablet
      ...
      <div className="fullScreen maxWidth1260Wrapper">
        <WidthOneContent $first>
          <Img $whiteImgBackgroundBorder src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/06_ChemicalSafety/group1/4.png`} />
          <CustomText
            text={
              isMobile
        ...
        <WidthOneContent $last>
          <Img $whiteImgBackgroundBorder src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/06_ChemicalSafety/group1/5.png`} />
          <CustomText
            text={
              isMobile
