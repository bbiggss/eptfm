  ...
  return (
    <StyledInformationDisclosure>
      ...
      <div className="smallScreen">
        <WidthImgOneTextsOne>
          <Img src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/05_InformationDisclosure/group2_1.png`} />
          <ProjectDescription
            textPosition={'right'}
            text={
              isMobile
        ...
        <WidthImgOneTextsOne>
          ...
          />
          <Img src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/05_InformationDisclosure/group2_2.png`} />
        </WidthImgOneTextsOne>
        <WidthImgOneTextsOne>
          <Img src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/05_InformationDisclosure/group2_3.png`} />
          <ProjectDescription
            textPosition={'right'}
            text={
              isMobile
        ...
        <WidthImgOneTextsOne>
          ...
          />
          <Img src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/05_InformationDisclosure/group2_4.png`} />
        </WidthImgOneTextsOne>
        <WidthImgOneTextsOne>
          <Img src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/05_InformationDisclosure/group2_5.png`} />
          <ProjectDescription
            textPosition={'right'}
            text={
              isMobile
        ...
        <WidthImgOneTextsOne>
          ...
          />
          <Img src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/05_InformationDisclosure/group2_6.png`} />
        </WidthImgOneTextsOne>
        <WidthImgOneTextsOne>
          <Img src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/05_InformationDisclosure/group2_7.png`} />
          <ProjectDescription
            textPosition={'right'}
            text={
              isMobile
        ...
        <WidthImgOneTextsOne pcPaddingBottom="200px" mobilePaddingBottom={'142px'}>
          ...
          />
          <Img src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/05_InformationDisclosure/group2_8.png`} />
        </WidthImgOneTextsOne>
      </div>
    </StyledInformationDisclosure>
  );
