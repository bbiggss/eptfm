    ...
    <StyledCyberSocializingTwo>
      ...
      <div className="smallScreen">
        <WidthImgOneTextsOne pcPaddingTop="200px" mobilePaddingTop={'150px'}>
          <Img src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/04_CyberSocializingTwo/group1/1.png`} />
          <ProjectDescription
            textPosition={'right'}
        ...
        <WidthImgOneTextsOne>
          ...
          />
          <Img src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/04_CyberSocializingTwo/group1/2.png`} />
        </WidthImgOneTextsOne>
        <WidthImgOneTextsOne>
          <Img src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/04_CyberSocializingTwo/group1/3.png`} />
        ...
        <WidthImgOneTextsOne>
          ...
          />
          <Img src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/04_CyberSocializingTwo/group1/4.png`} />
        </WidthImgOneTextsOne>
        <WidthImgOneTextsOne>
          <Img src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/04_CyberSocializingTwo/group1/5.png`} />
          <ProjectDescription
            textPosition={'right'}
            text={
              isMobile
        ...
        <WidthImgOneTextsOne>
          ...
          <Img src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/04_CyberSocializingTwo/group1/6.png`} />
        </WidthImgOneTextsOne>
        <WidthImgOneTextsOne>
          <Img src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/04_CyberSocializingTwo/group1/7.png`} />
          <ProjectDescription
            textPosition={'right'}
        ...
        <WidthImgOneTextsOne pcPaddingBottom="200px" mobilePaddingBottom={'142px'}>
          ...
          />
          <Img src={`${process.env.PUBLIC_URL}/assets/images/portfolio/e-Learning/detail/04_CyberSocializingTwo/group1/8.png`} />
        </WidthImgOneTextsOne>
      </div>
    </StyledCyberSocializingTwo>
  );
