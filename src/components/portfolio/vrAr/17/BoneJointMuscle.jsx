...
const BoneJointMuscle = () => {
  ...
  return (
    <StyledBoneJointMuscle>
      ...
      <WidthOneContent>
        <ProjectImg src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/17_BoneJointMuscle/group1_1.png`} />
        <TextCenter
          text={
      ...
      <WidthOneContent>
        <ProjectImg src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/17_BoneJointMuscle/group1_2.png`} />
        <TextCenter
          text={
      ...
      <WidthOneContent>
        <ProjectImg src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/17_BoneJointMuscle/group1_3.png`} />
        <TextCenter text={'AR로 직접 탐험하는 뼈의 세계! \n두개골에서 발끝까지 우리몸을 지탱하는 뼈들을 자세히 살펴볼까요?'} />
      </WidthOneContent>
      <WidthOneContent>
        <ProjectImg src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/17_BoneJointMuscle/group1_4.png`} />
        <TextCenter
          text={
      ...
      <WidthOneContent>
        <ProjectImg src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/17_BoneJointMuscle/group1_5.png`} />
        <TextCenter
          text={
      ...
      <WidthOneContent>
        <ProjectImg src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/17_BoneJointMuscle/group1_6.png`} />
        <TextCenter
          text={
      ...
      <WidthOneContent className="lastChild">
        <ProjectImg src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/17_BoneJointMuscle/group1_7.png`} />
        <TextCenter
          text={
