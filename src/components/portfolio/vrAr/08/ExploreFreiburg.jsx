  ...
  return (
    <StyledExploreFreiburg>
      ...
      <WidthOneContent $first>
        <Img src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/08_ExploreFreiburg/main2.png`} />
        <CustomText
      ...
      <div className="fullScreen fff6df relative">
        ...
        <Zigzag>
          <div className="left" style={{ order: 1 }}>
            <ZigZagImgTexts
              style={{ order: 1 }}
          ...
          <div className="right" style={{ order: 2 }}>
            <ZigZagImgTexts
              style={{ order: 2 }}
      ...
      <div className="tempWrap textCenter">
        <div className="fullScreen">
          <WidthOneContent $first>
            <img className="left2" src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/08_ExploreFreiburg/side2.png`} alt="" />
            <ProjectImg src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/08_ExploreFreiburg/group2_1.png`} />
            <TextCenter text={'자전거와 트램을 이용한 친환경 교통정책을 체험할 수 있어요.\n여기는 자전거와 트램 천국!'} />
          </WidthOneContent>
          <WidthOneContent>
            <ProjectImg src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/08_ExploreFreiburg/group2_2.png`} />
            <TextCenter
              text={
          ...
          <WidthOneContent>
            <img className="right2" src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/08_ExploreFreiburg/side3.png`} alt="" />
            <ProjectImg src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/08_ExploreFreiburg/group2_3.png`} />
            <TextCenter
              text={
          ...
          <WidthOneContent>
            <ProjectImg src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/08_ExploreFreiburg/group2_4.png`} />
            <TextCenter
              text={
          ...
          <WidthOneContent>
            ...
            <ProjectImg src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/08_ExploreFreiburg/group2_5.png`} />
            <TextCenter text={'세계 최초 회전형 태양광 주택을 탐험하며 에너지 생산의 혁신을 학습해보세요.\n돌아가는 태양광 주택, 헬리오트롭!'} />
          </WidthOneContent>
          <WidthOneContent>
            <ProjectImg src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/08_ExploreFreiburg/group2_6.png`} />
            <TextCenter
              text={
