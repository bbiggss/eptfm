  ...
  return (
    <StyledMayor>
      ...
      {/* <div className="fullScreen relative">
        <img className="ellipse1" src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/11_Mayor/Ellipse1.png`} alt="" />
      </div> */}
      ...
      <div className="tempWrap">
        <div className="smallScreen">
          <div className="mainContainer">
            ...
            <img src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/11_Mayor/main1.png`} alt="" />
          </div>
        </div>

        <div className="fullScreen">
          <div className="introduction">
            <img src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/11_Mayor/main2.png`} alt="" />
        ...
        <WidthOneContent>
          <ProjectImg src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/11_Mayor/group2_1.png`} />
          <TextCenter
            text={
        ...
        <WidthOneContent>
          <ProjectImg src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/11_Mayor/group2_2.png`} />
          <TextCenter
            text={
        ...
        <WidthOneContent>
          <ProjectImg src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/11_Mayor/group2_3.png`} />
          <TextCenter
            text={
        ...
        <WidthOneContent>
          <ProjectImg src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/11_Mayor/group2_4.png`} />
          <TextCenter text={'학습자들의 이름을 넣은 선거 포스터를 만들어볼 수 있어요!\n정말 후보자가 된 기분, 마치 슈퍼스타가 된 느낌이죠?'} />
        </WidthOneContent>

        <div className="fullScreen AC9EFF">
          <div className="smallScreen">
            <WidthImgOneTextsOne pcPaddingTop="160px">
              <ProjectImg src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/11_Mayor/group3_1.png`} />
              <ProjectDescription
                style={{ color: '#292929' }}
                textPosition={'right'}
            ...
            <WidthImgOneTextsOne>
              ...
              />
              <ProjectImg src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/11_Mayor/group3_2.png`} />
            </WidthImgOneTextsOne>
            <WidthImgOneTextsOne>
              <ProjectImg src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/11_Mayor/group3_3.png`} />
              <ProjectDescription
                style={{ color: '#292929' }}
                textPosition={'right'}
            ...
            <WidthImgOneTextsOne>
              ...
              />
              <ProjectImg src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/11_Mayor/group3_4.png`} />
            </WidthImgOneTextsOne>
          </div>
        </div>

        <WidthOneContent>
          <ProjectImg src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/11_Mayor/group2_5.png`} />
          <TextCenter
            text={'다양한 선거운동을 통해 유권자들에게 지지를 호소할 수 있어요.\n거리 유세, SNS 활용 뿐만 아니라 TV에서 토론회를 할 수도 있답니다!'}
          />
        </WidthOneContent>
        <WidthOneContent>
          <ProjectImg src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/11_Mayor/group2_6.png`} />
          <TextCenter
            text={
        ...
        <WidthOneContent className="lastChild">
          <ProjectImg src={`${process.env.PUBLIC_URL}/assets/images/portfolio/VrAr/detail/11_Mayor/group2_7.png`} />
          <TextCenter
            text={
