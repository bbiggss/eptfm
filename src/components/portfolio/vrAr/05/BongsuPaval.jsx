...
import { BongsuPavalBox } from '../../../../assets/styles/portfolio/vrAr/05_BongsuPaval/StyledBongsuPaval';
          ...
          <div className="top-row">
            ...
            <div className="introudctionWrapper">
              ...
              {/* <PortfolioIntroductionTitle
                pcMarginTop={''}
                pcMarginBottom={'34px'}
                mobileMarginTop={'17px'}
                mobileMarginBottom={'20px'}
                title={isMobileTablet ? '불과 연기로 전하는\n 고대의 지혜!' : '불과 연기로 전하는 고대의 지혜!'}
              />
