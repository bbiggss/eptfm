    ...
    if (location.pathname.split('/')[2] === 'VrAr') {
      ...
      const portfolioItems2 = [
        ...
        },
        {
          ...
          mobile_pfItemSmallTitle: 'VR I 모네의 작품으로 알아보는 프랑스 기후와 주민생활',
        },
        {
        ...
        },
        {
          ...
          mobile_pfItemSmallTitle: 'AR I 뼈, 관절, 근육! 우리 몸을 움직이는\n 세박자',
        },
        {
...

        {
          ...
          mobile_pfItemSmallTitle: 'VR I 이중섭 작품을 통해 알아보는 6·25\n 전쟁',
        },
      ];
      ...
      const portfolioItems2 = [
        ...
        },
        {
          ...
          mobile_pfItemSmallTitle: '정보공시 입력 지침 안내와 시스템매뉴얼',
        },
        {
          ...
          mobile_pfItemSmallTitle: '화학물질안전에 대하여',
        },
        {
          ...
          mobile_pfItemSmallTitle: '처음 만나는 동아시아사',
        },
        {
          ...
          mobile_pfItemSmallTitle: '위탁모를 위한 양육 길잡이',
        },
      ];
      updatePortfolioItems(portfolioItems2);
    } else {
      ...
      const portfolioItems2 = [
        ...
        },
        {
          ...
          mobile_pfItemSmallTitle: '교실혁명 강의교안',
        },
      ];
      updatePortfolioItems(portfolioItems2);
    }
