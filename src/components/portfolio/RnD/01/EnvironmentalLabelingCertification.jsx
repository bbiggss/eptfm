              ...
              <ProjectDescription
                ...
                text={
                  isMobile
                    ...
                    : isTablet
                    ? '다양한 인증 사례와 데이터를 조사하고 분석하여,\n 복잡한 절차를 쉽게 이해할 수 있는 상호작용 학습 컨텐츠를\n 만들었어요. 이제 여러분도 친환경 인증의 중요성을\n 이해하고 실천할 수 있어요!\n\n인증 받은 제품을 사용할 때마다\n 지구가 살짝 미소 짓는 것 같지 않나요?'
            ...
            <CustomText
              ...
              text={
                isMobile
                  ...
                  : isTablet
                  ? '환경표지가 붙은 제품이 무엇을 의미하는지 설명하고,\n 환경표지가 소비자에게 제공하는 정보와 신뢰성에 대해\n 설명해요. 환경표지가 붙은 제품을 왜 사용해야 할까요?\n환경표지가 붙은 제품을 선택할 때의 이점과\n 그 제품이 환경에 미치는 긍정적인 영향을 확인해보세요!'
